...
MAX_DEADLINE_VARIANCES=(200 25 100) # Keep deadline tight. Don't change this
SCHEDULER_TIME_DISCRETIZATIONS=(1)
GAMMA_COEFFICIENTS=(1 4 2) #cv2 don't change this
RELEASE_POLICIES=(fixed_gamma)
POISSON_ARRIVAL_RATES=(0.5 1) # Tune this
BASE_ARRIVAL_RATES=(0.25 0.5) # Tune this
DAG_AWARENESS=(1) # False True
TASK_CPU_DIVISOR=25
TASK_DURATION_MULTIPLER=1.5
...
WORKLOAD_PROFILE_PATH=./traces/alibaba-cluster-trace-v2018/jobs_having_ctp_gt_4.pkl
...
--alibaba_task_duration_multiplier=${TASK_DURATION_MULTIPLER}
"
