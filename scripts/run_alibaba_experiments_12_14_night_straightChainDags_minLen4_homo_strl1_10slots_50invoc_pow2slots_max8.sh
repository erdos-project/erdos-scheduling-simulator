...
MAX_DEADLINE_VARIANCES=(25 200) # Keep deadline tight. Don't change this
SCHEDULER_TIME_DISCRETIZATIONS=(1)
GAMMA_COEFFICIENTS=(1 2 4) #cv2 don't change this
RELEASE_POLICIES=(fixed_gamma)
POISSON_ARRIVAL_RATES=(0.02 0.05) # Tune this
BASE_ARRIVAL_RATES=(0.01 0.01) # Tune this
DAG_AWARENESS=(1) # False True
# TASK_CPU_DIVISOR=25
TASK_MAX_POW2_SLOTS=8

DYNAMIC_DISCRETIZATION=0
...
--scheduler=${SCHEDULER}
--alibaba_loader_task_max_pow2_slots=${TASK_MAX_POW2_SLOTS}
"
