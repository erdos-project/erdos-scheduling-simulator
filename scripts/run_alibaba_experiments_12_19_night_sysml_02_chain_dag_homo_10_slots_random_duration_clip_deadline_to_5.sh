...
MAX_DEADLINE_VARIANCES=(50 25 100 200) # Keep deadline tight. Don't change this
SCHEDULER_TIME_DISCRETIZATIONS=(1)
GAMMA_COEFFICIENTS=(1) #cv2 don't change this
RELEASE_POLICIES=(fixed_gamma)
POISSON_ARRIVAL_RATES=(0.012) # Tune this
