...
MAX_DEADLINE_VARIANCES=(25 100) # Keep deadline tight. Don't change this
SCHEDULER_TIME_DISCRETIZATIONS=(1)
GAMMA_COEFFICIENTS=(1 2) #cv2 don't change this
RELEASE_POLICIES=(fixed_gamma)
POISSON_ARRIVAL_RATES=(0.03) # Tune this
BASE_ARRIVAL_RATES=(0) # Tune this
