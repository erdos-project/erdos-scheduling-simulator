    ...
    def schedule(self,
        ...
        Args:
            resource_requirement: List[List[bool]], List of lists of booleans,
                where each sublist is a list of booleans indicating whether a task
                conforms to a resource type.
            ...
            enforce_deadline (`bool`): Deadline must be met or else the schedule will return none.
        ...
        for i, (p, res_req) in enumerate(zip(placements,
            ...
            ### Legacy code for converting to bitvec to speed up solving if the number of a particular resource is small
            ...
            # else:
            #     raise ValueError("Resource must be only be allowed on one resource")
