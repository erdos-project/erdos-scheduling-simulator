...
namespace tetrisched
{
  ...
  public:
    ...
    DiscretizationSelectorOptimizationPass(Time minDiscretization = 1, Time maxDiscretization = 5, float maxOccupancyThreshold = 0.8);
  ...
  public:
    ...
    OptimizationPassRunner(bool debug = false, bool enableDynamicDiscretization = false, Time minDiscretization = 1, Time maxDiscretization = 5, float maxOccupancyThreshold = 0.8);
