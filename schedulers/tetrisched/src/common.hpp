...
/// A WorkerEquivalenceSet is a set of Workers that are equivalent to each
/// other when viewed from the perspective of a given Job.
typedef std::vector<WorkerPtr> WorkerEquivalenceSet;
