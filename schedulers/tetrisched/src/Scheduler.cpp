...
{
  Scheduler::Scheduler(Time discretization, SolverBackendType solverBackend, std::string logDir, bool enableDynamicDiscretization, Time maxDiscretization, float maxOccupancyThreshold)
