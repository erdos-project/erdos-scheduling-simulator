...
TEST(OptimizationTest, TestBasicCriticalPathOptimizationPass) {
  ...
  tetrisched::ExpressionPtr chooseExpression_1 =
      std::make_shared<tetrisched::ChooseExpression>("task1_1", partitions, 0,
                                                     10, 20, 1);
  tetrisched::ExpressionPtr chooseExpression_2 =
      std::make_shared<tetrisched::ChooseExpression>("task1_2", partitions, 0,
                                                     20, 20, 1);
  tetrisched::ExpressionPtr chooseExpression_3 =
      std::make_shared<tetrisched::ChooseExpression>("task1_3", partitions, 0,
                                                     30, 20, 1);
  ...
  tetrisched::ExpressionPtr chooseExpression_4 =
      std::make_shared<tetrisched::ChooseExpression>("task2_1", partitions, 0,
                                                     10, 30, 1);
  tetrisched::ExpressionPtr chooseExpression_5 =
      std::make_shared<tetrisched::ChooseExpression>("task2_2", partitions, 0,
                                                     20, 30, 1);
  tetrisched::ExpressionPtr chooseExpression_6 =
      std::make_shared<tetrisched::ChooseExpression>("task2_3", partitions, 0,
                                                     30, 30, 1);
  ...
  tetrisched::CapacityConstraintMapPtr capacityConstraintMap =
      std::make_shared<tetrisched::CapacityConstraintMap>(1);
