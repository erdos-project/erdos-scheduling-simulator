...
from workload import ExecutionStrategies, ExecutionStrategy, Job, JobGraph
...
def test_conditional_job_construction():
    ...
    job = Job(
        name="Perception", execution_strategies=ExecutionStrategies(), conditional=True
    )
    assert job.name == "Perception", "Job has the wrong name."
...
def test_job_equivalence():
    ...
    job_1 = Job(name="Perception", execution_strategies=ExecutionStrategies())
    job_2 = Job(name="Planning", execution_strategies=ExecutionStrategies())
...
def test_job_addition_with_no_children():
    ...
    job_graph.add_job(Job(name="Planning", execution_strategies=ExecutionStrategies()))
...
def test_failed_retrieval_of_children():
    ...
    job_graph = JobGraph(name="test_job_graph")
    job = Job(name="Perception", execution_strategies=ExecutionStrategies())
...
def test_iteration_jobgraph():
    ...
    job_graph = JobGraph(name="test_job_graph")
    camera_job = Job(name="Camera", execution_strategies=ExecutionStrategies())
    lidar_job = Job(name="Lidar", execution_strategies=ExecutionStrategies())
    lidar_coordinate_mapping_job = Job(
        name="LidarToCameraMapping", execution_strategies=ExecutionStrategies()
    )
    perception_job = Job(name="Perception", execution_strategies=ExecutionStrategies())
...
def test_topological_sort_success():
    ...
    job_graph = JobGraph(name="test_job_graph")
    job_0 = Job(name="Job 0", execution_strategies=ExecutionStrategies())
    job_1 = Job(name="Job 1", execution_strategies=ExecutionStrategies())
    job_2 = Job(name="Job 2", execution_strategies=ExecutionStrategies())
    job_3 = Job(name="Job 3", execution_strategies=ExecutionStrategies())
    job_4 = Job(name="Job 4", execution_strategies=ExecutionStrategies())
    job_5 = Job(name="Job 5", execution_strategies=ExecutionStrategies())
