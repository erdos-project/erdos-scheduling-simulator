...
def main(args):
    ...
    for i in range(1, 11, 1):
        ...
        outpath = (FLAGS.outpath +
                   "/tasks={}_horizon={}_ngpu={}_ncpu={}/".format(
                       num_tasks, horizon, FLAGS.NUM_GPUS, FLAGS.NUM_CPUS)
                   if FLAGS.dump else None)
        if outpath is not None and not Path(outpath).is_dir():
            Path(outpath).mkdir()
        if mini_run:
            run_time = do_run(scheduler,
                              3,
                              10,
                              20,
                              2,
    ...
    # 10 GPUs
    # gurobi :: [
    #    (25, 0.08587193489074707),
    #    (50, 0.35022997856140137),
    #    (75, 0.7291121482849121),
    #    (100, 1.3141570091247559),
    #    (125, 2.1521008014678955),
    #    (150, 3.3707449436187744),
    #    (175, 5.060914993286133),
    #    (200, 6.168315887451172),
    #    (225, 8.27920413017273),
    #    (250, 9.921762704849243)
    # ]
    # boolector :: [
    #    (25, 0.5251703262329102),
    #    (50, 2.3219339847564697),
    #    (75, 3.3040549755096436),
    #    (100, 4.810174942016602),
    #    (125, 8.076522827148438),
    #    (150, 9.844052791595459),
    #    (175, 14.263533115386963),
    #    (200, 18.89586591720581),
    #    (225, 34.64178729057312),
    #    (250, 55.9284348487854)
    # ]
    # z3 feasible :: [
    #    (25, 0.27488088607788086),
    #    (50, 0.9974880218505859),
    #    (75, 2.5175118446350098),
    #    (100, 28.96995210647583),
    #    (125, 31.289150953292847),
    #    (150, 34.28826403617859),
    #    (175, 38.13741493225098),
    #    (200, 46.34599494934082),
    #    (225, 59.39476490020752),
    #    (250, 60.48176574707031)
    # ]
    # z3opt :: [
    #    (25, 0.640681266784668),
    #    (50, 12.719839811325073),
    #    (75, 164.75238871574402),
    #    (100, TO: 600)
    # ]
    ...
    # z3 feasible ::
    # gurobi :: [
    #    (25, 0.1027829647064209),
    #    (50, 0.39047813415527344),
    #    (75, 0.8470158576965332),
    #    (100, 1.4896490573883057),
    #    (125, 2.4311540126800537),
    #    (150, 3.8708841800689697),
    #    (175, 5.760190963745117),
    #    (200, 7.8410608768463135),
    #    (225, 10.270406723022461),
    #    (250, 12.776335954666138)
    #    ]
    # 2 GPUs
    # gurobi :: [
    #    (25, 0.08508110046386719),
    #    (50, 0.31741905212402344),
    #    (75, 0.7181341648101807),
    #    (100, 1.3489925861358643),
    #    (125, 2.321063280105591),
    #    (150, 3.47944712638855),
    #    (175, 5.12633490562439),
    #    (200, 7.158405303955078),
    #    (225, 9.563724756240845),
    #    (250, 11.937131881713867)
    # ]
    # z3opt :: [
    #    (25, 0.23419690132141113),
    #    (50, 0.9150850772857666),
    #    (75, 1.9437358379364014),
    #    (100, 3.5848450660705566),
    #    (125, 6.172568082809448),
    #    (150, 9.15726900100708),
    #    (175, 12.562286853790283),
    #    (200, 16.593253135681152),
    #    (225, 21.504096031188965),
    #    (250, 27.45561718940735)
    # ]
    # boolector :: [
    #    (25, 0.5381882190704346),
    #    (50, 3.617543935775757),
    #    (75, 31.951995134353638),
    #    (100, 86.47850918769836),
    #    (125, 183.3293433189392),
    #    (150,314.9739718437195),
    #    (175, TO: 600)
    # ]
